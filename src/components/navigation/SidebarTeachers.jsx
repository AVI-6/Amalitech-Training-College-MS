      ...
      <div className="menu-container">
        ...
        <div className="nav-acc-div">
          <div className="nav-links">
            <NavLink to="/teachers/dashboard" className="nav-link">
              <IoApps className='nav-link-icon' />
              <p> Dashboard </p>
            </NavLink>
            <NavLink to="/teachers/courses" className="nav-link">
              <LuGraduationCap className='nav-link-icon' />
              <p> My Courses</p>
            </NavLink>
            <NavLink to="/teachers/assessments" className="nav-link">
              <MdPeopleAlt className='nav-link-icon' />
              <p> Assessments</p>
            </NavLink>
            <NavLink to="/teachers/resources" className="nav-link">
              <LuBookOpenText className='nav-link-icon' />
              <p> Resources</p>
            </NavLink>
            <NavLink to="/teachers/settings" className="settings nav-link">
              <GoGear className='nav-link-icon' />
              <p> Settings</p>
            </NavLink>
          </div>
          <div className="sidebar-profile">
            <NavLink to='/teachers/settings' className="profile-info">
