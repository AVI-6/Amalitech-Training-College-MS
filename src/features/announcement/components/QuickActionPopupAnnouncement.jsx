...
function QuickActionPopupAnnouncement({ isOpenAnnouncement, onCloseAnnouncement }) {
  return (
    <div className='modal'>
      <Modal className='modal-div' isOpen={isOpenAnnouncement} onClose={onCloseAnnouncement}>
        <h2>Post Announcement</h2>

        <div className="modal-card">
          <Link to={'/teachers/dashboard/post-announcements'}>
...
export default QuickActionPopupAnnouncement
