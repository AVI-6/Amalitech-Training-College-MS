...
function QuickActionPopupGrade({ isOpenGrade, onCloseGrade }) {
  return (
    <div className='modal'>
      <Modal className='modal-div' isOpen={isOpenGrade} onClose={onCloseGrade}>
        <h2>Record Grade</h2>

        <div className="modal-card">
          <Link to={'/teachers/assessments/grade'}>
...
export default QuickActionPopupGrade
